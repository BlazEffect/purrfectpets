...
return [
    ...
    'profiles' => [
        ...
        'full' => [
            'plugins' => 'accordion autoresize codesample directionality advlist autolink link lists charmap preview anchor pagebreak searchreplace wordcount visualblocks visualchars code fullscreen insertdatetime table emoticons template help',
            'toolbar' => 'undo redo removeformat | styles | bold italic | rtl ltr | alignjustify alignright aligncenter alignleft | numlist bullist outdent indent accordion | forecolor backcolor | blockquote table toc hr | link anchor codesample emoticons | visualblocks print code preview wordcount fullscreen help',
            'upload_directory' => null,
        ],
    ],
